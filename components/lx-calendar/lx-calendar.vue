...
<template>
	<view class="date">
		...
		<swiper :style="{height:(retract ? 5 * 80 : (week_list.length + 1) * 80 ) + 'rpx'}" :current="current" circular @change="change_date">
			<swiper-item>
...
.head{
	display: flex !important; align-items: center; height: 100rpx; justify-content: center;
...
.retract{
	display: flex !important; justify-content: center; align-items: center; height: 80rpx;;
	.iconfont{
